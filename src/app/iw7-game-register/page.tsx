...
export const metadata: Metadata = {
  title: "IW7 Game Register – Create Your Free Account in 60 Seconds",
  description: "Register for IW7 Game in under a minute. Free account creation, OTP verification, welcome bonus included. Step-by-step registration guide with tips for new players.",
  keywords: ["IW7 Game register", "IW7 Game sign up", "IW7 Game create account", "IW7 Game registration", "IW7 Game new account", "IW7 register free"],
  openGraph: {
    title: "IW7 Game Register – Create Your Free Account in 60 Seconds",
    description: "Register for IW7 Game. Free, fast, and includes a welcome bonus.",
    url: "https://iw7gamess.com/iw7-game-register",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "IW7 Game Register" }],
  },
  twitter: { card: "summary_large_image", title: "IW7 Game Register – Free Account", description: "Create your IW7 Game account in 60 seconds.", images: ["/og-image.png"] },
  alternates: { canonical: "https://iw7gamess.com/iw7-game-register" },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "IW7 Game Register", item: "https://iw7gamess.com/iw7-game-register" },
  ],
};

export default function IW7GameRegisterPage() {
  return (
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        <div className="container section-padding mx-auto text-center mx-auto">
          <nav className="mb-6 text-sm text-gray-500">
            ...
            <span className="text-gray-800 font-medium">IW7 Game Register</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="gradient-text">IW7 Game Register</span> – Join 500K+ Players
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Creating your IW7 Game account is free, takes under 60 seconds, and unlocks immediate access to 500+ premium games plus a generous welcome bonus. Here is exactly how to do it.
          </p>
          <TrackedCTALink location="iw7_game_register_cta" className="btn-cta text-lg px-10 py-4">
            Register Now
          </TrackedCTALink>
        </div>
      </section>
      ...
      <section>
        <div className="container section-padding mx-auto">
          <h2 className="text-3xl font-bold text-center mb-10">How to Register for IW7 Game</h2>
          <div className="max-w-3xl mx-auto space-y-6">
            {[
              { step: "1", title: "Open IW7 Game", desc: "Launch the IW7 app on your Android device. If you do not have it yet, download it from our official link — it is free and takes under a minute to install." },
              ...
              { step: "5", title: "Verify via OTP", desc: "IW7 sends a 6-digit verification code to your phone via SMS. Enter this code within 5 minutes to confirm your phone number is valid and belongs to you." },
      ...
      <section className="bg-primary-50">
        <div className="container section-padding mx-auto">
          <h2 className="text-3xl font-bold text-center mb-10">Tips for New IW7 Game Players</h2>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              { title: "Join the Community", desc: "Check out the in-app chat rooms and the official Telegram group. Other IW7 players share strategies, game recommendations, and bonus codes regularly." },
            ].map((tip, i) => (
          ...
          <div className="text-center mt-10">
            <TrackedCTALink location="iw7_game_register_cta" className="btn-primary px-8 py-3">
              Register for IW7 Game
            </TrackedCTALink>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="container section-padding mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/iw7-register" className="btn-outline">IW7 Register</Link>
            <Link href="/iw7-game-login" className="btn-outline">Login</Link>
            <Link href="/download" className="btn-outline">Download</Link>
            <Link href="/iw7-game-bonus" className="btn-outline">Welcome Bonus</Link>
