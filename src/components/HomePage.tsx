...
const infoRows = [
  ...
  { label: "Version", value: "1.3.6 (Latest 2026)" },
  { label: "App Size", value: "29 MB" },
...
const features = [
  {
    ...
    desc: "Create your IW7 Game account in under a minute. No lengthy forms, no waiting — just enter your details and start playing immediately.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  {
    q: "What is IW7 Game and how does it work?",
    a: "IW7 Game is a premium Android gaming platform offering 500+ games across categories like slots, live tables, sports, and arcade. Download the APK, create a free account, and start playing instantly.",
  },
  {
    q: "Is IW7 Game free to download and use?",
    a: "Yes, the IW7 Game APK is completely free to download and install. Creating an account costs nothing, and new players receive a welcome bonus to get started.",
  },
  {
    q: "How do I create an IW7 Game account?",
    a: "Open the IW7 app, tap Register, enter your mobile number or email, set a password, verify via OTP, and your account is ready in under 60 seconds.",
  },
  {
    q: "Is my personal information safe on IW7 Game?",
    a: "Absolutely. IW7 Game uses 256-bit SSL encryption, secure servers, and multi-factor authentication to protect all user data and transactions.",
  },
  {
    q: "What devices are compatible with IW7 Game?",
    a: "IW7 Game runs on any Android device with Android 5.0 or higher, at least 2GB RAM, and 60MB of free storage. It is optimized for both phones and tablets.",
  },
  {
    q: "How do I login to IW7 Game?",
    a: "Use your registered mobile number and password to login. IW7 Game also supports OTP-based login for quick access. If you forget your password, use the forgot password option to reset it.",
  },
  {
    q: "Can I withdraw my bonus money from IW7 Game?",
    a: "Bonus usage depends on the app terms. Usually, bonus amounts must be wagered before withdrawal. Check the IW7 Game app for current bonus terms and withdrawal requirements.",
  },
  {
    q: "Is IW7 Game available on the Play Store?",
    a: "Currently, IW7 Game is available via direct APK download from the official website. This allows faster updates and the full feature set without Play Store restrictions.",
  },
  {
    q: "What payment methods does IW7 Game support?",
    a: "IW7 Game supports UPI (PhonePe, GPay, Paytm), Net Banking, and IMPS for both deposits and withdrawals. Transactions are fast, secure, and have no hidden charges.",
  },
];
    ...
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 pt-4 pb-2 sm:py-2 sm:py-4relative">
          <div className="text-center mx-auto">
            <Image
              src="/iw7-game.webp"
              alt="IW7 Game - Premium Android Gaming Platform APK Download"
              width={180}
              height={180}
            ...
            <span className="inline-block px-2 sm:px-4 py-1.5 rounded-full bg-white/20 text-black text-sm font-medium mb-3 sm:mb-4 animate-fade-in backdrop-blur-sm">
              IW7 Game &bull; IW7 APK &bull; IW7 Gaming
            </span>
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-black leading-tight mb-4 sm:mb-6 animate-slide-up">
              IW7 Game – The Ultimate Android Gaming Platform with 500+ Premium Games
            </h1>
            <p className="text-sm sm:text-xl text-black leading-relaxed mb-4 sm:mb-5 animate-slide-up delay-200 mx-auto">
              Experience next-level mobile gaming with IW7. Download the IW7 APK, register in 60 seconds, and unlock daily rewards, exclusive bonuses, and a massive game library — all optimized for your Android device.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-2 sm:py-4relative">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
              IW7 Game at a Glance
            </h2>
            <p className="text-text-secondary max-w-lg mx-auto">
              Everything you need to know about the IW7 Game platform — quick overview of key details.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-5">
                What Makes IW7 Game the #1 Choice for Mobile Gamers
              </h2>
              <p className="text-text-secondary leading-relaxed mb-4">
                IW7 Game was built from the ground up as a mobile-first gaming platform. Unlike bloated desktop ports, every pixel of the IW7 interface is designed for touch screens, optimized for battery life, and engineered to run smoothly on devices from budget to flagship.
              </p>
              <p className="text-text-secondary leading-relaxed mb-4 sm:mb-6">
                With 500+ games updated weekly, a daily reward engine that keeps players engaged, and bank-level security protecting every transaction, IW7 Game delivers an experience that rivals top-tier gaming platforms worldwide.
              </p>
              <Link href="/about" className="btn-primary">
                Learn More About IW7
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-3 sm:py-5  relative">
          <div className="text-center mb-5">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
              Why Thousands Choose IW7 Game Every Day
            </h2>
            <p className="text-text-secondary mx-auto">
              From instant registration to lightning-fast payouts — here is what sets IW7 Game apart from every other platform.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-4 sm:mb-6">
                How to Download IW7 Game APK
              </h2>
              <div className="space-y-4">
                {[
                  "Tap the download button to get the latest IW7 APK.",
                  "Allow installation from unknown sources in Settings.",
                  "Open the downloaded file and tap Install.",
                  "Launch IW7 Game and create your free account.",
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-text-primary mb-5 flex items-center gap-2">
                ...
                IW7 Game Registration
              </h3>
              <div className="card-static p-6">
                <ol className="space-y-3">
                  {[
                    "Open IW7 Game and tap Register.",
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-3 sm:py-5  relative">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
              IW7 Game Rewards That Keep You Coming Back
            </h2>
            <p className="text-text-secondary mx-auto">
              IW7 Game offers one of the most generous reward systems in mobile gaming. Here is what awaits you.
            </p>
          </div>
          ...
          <p className="text-center text-sm text-text-muted mt-6">
            Promotions are updated regularly. Check the IW7 Game app for the latest offers and eligibility.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-3 sm:py-5 relative">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
              IW7 Game Deposit & Withdrawal Methods
            </h2>
            <p className="text-text-secondary mx-auto">
      ...
      <section className="section-padding bg-surface">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-2 sm:py-4relative">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
              Pro Tips for IW7 Game Players
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { icon: "🔐", tip: "Enable two-factor authentication for maximum account security." },
              { icon: "🔄", tip: "Update IW7 Game weekly to access new games and performance improvements." },
              ...
              { icon: "✅", tip: "Only download the IW7 APK from iw7gamess.com or the official link." },
      ...
      <section className="section-padding bg-white" id="faq">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-2 sm:py-4relative">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
              Frequently Asked Questions About IW7 Game
            </h2>
            <p className="text-text-secondary">
              Quick answers to the most common questions about IW7 Game, IW7 APK download, and account management.
            </p>
          </div>
